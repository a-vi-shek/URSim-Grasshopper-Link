...
8. While the VM is active, in Windows, go to Run> CMD and ping the IP address using `ping 192.168.56.103`. If everything has been followed properly you should get reply from the server.
